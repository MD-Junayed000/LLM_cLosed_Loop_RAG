...
\textbf{Second—probes aren't fact-checkers.} The probes measure hallucination \emph{risk} using activation patterns. They are not prophets. When the internal state of the model looks the same as grounded generation  (see Example~2.7.3 in Section~\ref{sec:illustrative_examples}), the probe will fail to detect a confident but baseless extraction.
